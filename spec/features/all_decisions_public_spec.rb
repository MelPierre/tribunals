  ...
  feature 'Visit public pages of a tribunal' do
    ...
    context 'FTT' do
      scenario "can view the index page of FTT tribunal" do
        30.times{ create(:all_decision, all_decision_hash(tribunal_id: ftt.id, file_number: 'FTT24267', text: "Some searchable green text is here")) }
        visit '/ftt-tax'
    ...
    context 'EAT' do
      scenario "can view the index page of EAT tribunal" do
        30.times{ create(:all_decision, all_decision_hash(tribunal_id: eat.id, file_number: 'EAT24267', text: "Some searchable green text is here")) }
        visit '/eat'
